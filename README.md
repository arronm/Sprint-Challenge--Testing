...
- [x] `describe()` signifies a suite of tests that outlines the overall unit that you're testing (macro)
- [x] `it()` signifies a single test on a particular unit that you're testing (micro)
1. What is the point of `Test Driven Development`? What do you think about this approach?
- [x] TDD forces you to think about code structure differently, so you write your units in a way that handles edge cases from the start
- [x] This is technically two questions, what kind of trick is this... I think this approach is the more professional way to write code as it decreases production bugs and makes for cleaner robust programs
...
- [x] Add a `PUT /games/:id` endpoint that can edit the corresponding game. If the game does not exist return a 404 status code. Write tests for this endpoint.
- [x] Deploy to Heroku
